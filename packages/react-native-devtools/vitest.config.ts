...
export default defineConfig({
  resolve: {
    alias: [
      ...
      // Deep-import entry first — Vite alias `find` is a prefix match.
      { find: "@shipeasy/devtools-core/", replacement: at("../devtools-core/src/") },
      { find: "@shipeasy/devtools-core", replacement: at("../devtools-core/src/index.ts") },
    ],
  },
  test: {
