...
| [browser devtools](https://github.com/shipeasy-ai/sdk/blob/main/docs/pages/browser-devtools.md) | The in-browser devtools overlay ships inside the SDK, sharing one headless core (@shipe… |
