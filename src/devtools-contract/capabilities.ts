...
/** Project capabilities the devtools overlays render against. This is the
 *  payload the client Engine publishes over the bridge below, so it lives here
 *  in the contract rather than in the overlays' own type module — both sides
 *  must agree on it. @shipeasy/devtools-core re-exports it for convenience. */
